...
namespace Cifrados.Modelo
{
	public class ZigZag
	{
		...
		public void TodoZigZag(FileStream ArchivoImportado, string opcion, int niveles, string textoparacomprimir)
		{
			...
			if (ArchivoImportado != null)
			{
				...
				if (opcion == "Cifrar")
				{
					...
					using (var writeStream = new FileStream(("Mis Cifrados/CIFRADO_" + opcion + "_" + nombreArchivo + ".zz"), FileMode.OpenOrCreate))
					{
